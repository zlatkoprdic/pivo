...
This repository describes the pivo API. The description from the master branch is automatically rendered into [API Documentation](http://docs.pivo.apiary.dev).
...
If you want to develop a client for this API, head [to the documentation](http://docs.pivo.apiary.dev) to get the address of the mock server (lives on `apiary-mock.com`) generated from this blueprint.
